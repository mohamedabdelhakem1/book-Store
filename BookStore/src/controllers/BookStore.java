...
public class BookStore {
	...
	public boolean signUp(String userName, String password, String email, String fname, String lastname,
			String shippingAddress, String phoneNum) {
		user = new User();
...
//		return true;
	...
	public boolean checkout(String eDate, String cardNO) {
		...
		calendar.set(Calendar.MONTH, Integer.valueOf(strs[0])-1);
		calendar.set(Calendar.DATE, 01);
		calendar.set(Calendar.YEAR, Integer.valueOf(strs[1]));
		return salesRoute.checkout(cardNO, calendar.getTime(),
				user.getUsername(), user.getCart().getItems()).equals("success");
	}
}
